...
import { CarroPipaRecord } from "@/hooks/useCarroPipa";
import { format } from "date-fns";
import { ptBR } from "date-fns/locale";

interface CarroPipaTableDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  records: CarroPipaRecord[];
}
...
export function CarroPipaTableDialog({
  open,
  onOpenChange,
  records,
}: CarroPipaTableDialogProps) {
